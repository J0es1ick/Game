...
import type { DungeonNodeKind, DungeonRoute } from "../dungeons/DungeonRoute";
import type { CrownSeasonResult, CrownSeasonState } from "../world/CrownSeason";
import type { LootPityState, LootTarget } from "../equipment/LootProgression";
import type { EraChallengeProgressState } from "../world/EraChallenges";
import type { BattleSessionSnapshot } from "../combat/AdvancedBattle";
import type { NpcLifeWorldState } from "../world/NpcLifeSimulation";
import type { WorldSeasonResult, WorldSeasonState } from "../world/WorldSeason";
import type { FactionCampaignState } from "../world/FactionCampaign";
...
export type EquipmentSlot =
  "weapon" | "offhand" | "head" | "chest" | "hands" | "feet";
...
export type NpcActivity =
  "training" | "arena" | "dungeon" | "shopping" | "forging" | "rest";
...
export type EnemyMemoryStage =
  "unknown" | "observing" | "familiar" | "adapted" | "mastered";
export type HeroBehaviorPattern =
  "pressure" | "healing" | "control" | "burst" | "finisher";
...
export type ContractObjective =
  "training" | "duel" | "dungeon" | "tournament" | "boss";
