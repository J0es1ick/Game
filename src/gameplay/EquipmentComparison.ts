...
import type { EquipmentItem, HeroProfile, Stats } from "./WorldTypes";

export function effectiveEquipmentStats(hero: HeroProfile, replacement?: EquipmentItem, currentItem?: EquipmentItem): Stats {
  ...
  return { health: snapshot.maxHealth, attack: snapshot.attack, defense: snapshot.defense, speed: snapshot.speed, crit: snapshot.crit };
}

export function compareEquipment(hero: HeroProfile, candidate: EquipmentItem, previous?: EquipmentItem) {
