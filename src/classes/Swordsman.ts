...
export class Swordsman extends Player {
  ...
  public readonly mechanic = {
    ...
    description:
      "При тяжёлом ранении мечник ускоряет темп и проводит второй удар.",
  };
  ...
  protected override modifyOutgoingDamage(damage: number): number {
    ...
    this.recordDispatch(
      "Swordsman.modifyOutgoingDamage()",
      "Ранение открыло темп второго клинка.",
    );
  ...
  public override modifyCombatAttack(
    ...
    return context.healthRatio < threshold
      ? {
          ...
          detail: "раненый темп двух клинков",
        }
      : { damage };
  }
