...
const ARENA_DEFINITIONS: ArenaDefinition[] = [
  { id: "yard", kind: "arena", name: "Кубок Нижнего города", place: "Двор новичков", description: "Нелетальная сетка для тех, кто только ищет имя.", minLevel: 1, enemyLevel: [1, 4], winsToAdvance: 2, rewardGold: 150, rewardExperience: 140, lethalChance: 0, tournamentInterval: 2, participants: 8, prestige: "local", accent: "#718c64" },
  { id: "quarry", kind: "arena", name: "Каменный кубок", place: "Старая каменоломня", description: "Региональный турнир, где поражение иногда становится последним.", minLevel: 3, enemyLevel: [3, 7], winsToAdvance: 3, rewardGold: 320, rewardExperience: 250, lethalChance: 0.05, tournamentInterval: 3, participants: 8, prestige: "regional", accent: "#9a7655" },
  { id: "harbor", kind: "arena", name: "Турнир Медного причала", place: "Туманный порт", description: "Шестнадцать наёмников, дуэлянтов и беглых капитанов.", minLevel: 6, enemyLevel: [6, 11], winsToAdvance: 3, rewardGold: 620, rewardExperience: 420, lethalChance: 0.08, tournamentInterval: 4, participants: 16, prestige: "regional", accent: "#527a7b" },
  { id: "red-hall", kind: "arena", name: "Игры Красного зала", place: "Крепость наместника", description: "Большое событие: шестнадцать бойцов и титул наместника.", minLevel: 10, enemyLevel: [10, 16], winsToAdvance: 4, rewardGold: 1050, rewardExperience: 650, lethalChance: 0.12, tournamentInterval: 6, participants: 16, prestige: "grand", accent: "#9c5044" },
  { id: "glass", kind: "arena", name: "Стеклянный гран-при", place: "Верхний город", description: "Редкий турнир на тридцать два переживших десятки боёв имени.", minLevel: 15, enemyLevel: [15, 23], winsToAdvance: 4, rewardGold: 1900, rewardExperience: 950, lethalChance: 0.16, tournamentInterval: 9, participants: 32, prestige: "grand", accent: "#756b9a" },
  { id: "crown", kind: "arena", name: "Королевский турнир", place: "Сердце столицы", description: "Главное событие мира: тридцать два сильнейших и одна Корона.", minLevel: 22, enemyLevel: [22, 35], winsToAdvance: 5, rewardGold: 4200, rewardExperience: 1700, lethalChance: 0.2, tournamentInterval: 14, participants: 32, prestige: "royal", accent: "#b68a35" },
];

export const ARENAS: TournamentArena[] = ARENA_DEFINITIONS.map((definition) => new TournamentArena(definition));

export const DUNGEONS: DungeonDefinition[] = [
  { id: "cellar", kind: "dungeon", name: "Затопленный подвал", place: "За трактиром", description: "Короткая вылазка за монетами и простым снаряжением.", minLevel: 2, requiredArena: 0, requiredWorldDay: 2, enemyLevel: [2, 5], rewardGold: 80, rewardExperience: 60, minimumRarity: "common", cooldownDays: 2, accent: "#567c73" },
  { id: "catacombs", kind: "dungeon", name: "Катакомбы звонаря", place: "Старое кладбище", description: "Редкие вещи остаются у тех, кто не вернулся наверх.", minLevel: 5, requiredArena: 1, requiredWorldDay: 7, enemyLevel: [5, 9], rewardGold: 145, rewardExperience: 105, minimumRarity: "rare", cooldownDays: 3, accent: "#6d6959" },
  { id: "forge", kind: "dungeon", name: "Погасшая кузня", place: "Чёрный хребет", description: "Механизмы кузни охраняют оружие прежних мастеров.", minLevel: 9, requiredArena: 2, requiredWorldDay: 15, enemyLevel: [9, 15], rewardGold: 245, rewardExperience: 170, minimumRarity: "rare", cooldownDays: 4, accent: "#9b573f" },
  { id: "archive", kind: "dungeon", name: "Архив без имён", place: "Под башней магов", description: "Эпические реликвии меняют правила боя владельца.", minLevel: 14, requiredArena: 3, requiredWorldDay: 28, enemyLevel: [14, 22], rewardGold: 390, rewardExperience: 260, minimumRarity: "epic", cooldownDays: 5, accent: "#625d91" },
  { id: "vault", kind: "dungeon", name: "Хранилище первого короля", place: "За Северными воротами", description: "Источник легендарных и мифических предметов.", minLevel: 21, requiredArena: 4, requiredWorldDay: 45, enemyLevel: [21, 34], rewardGold: 680, rewardExperience: 400, minimumRarity: "legendary", cooldownDays: 7, accent: "#b38b38" },
];

export const DUEL_TIERS: DuelDefinition[] = [
  { id: "sparring", kind: "duel", name: "Вольный спарринг", place: "Двор оружейников", description: "Нелетальный бой с соперником близкой силы. Основной способ набрать опыт дуэлянта.", minLevel: 1, requiredDuelWins: 0, requiredArena: 0, enemyLevelOffset: [-1, 1], rewardGold: 55, rewardExperience: 60, accent: "#718c64" },
  { id: "licensed", kind: "duel", name: "Лицензированная дуэль", place: "Дом секундантов", description: "Более опытные противники, лучшие выплаты и строгий подбор по снаряжению.", minLevel: 6, requiredDuelWins: 8, requiredArena: 1, enemyLevelOffset: [0, 2], rewardGold: 150, rewardExperience: 130, accent: "#9a7655" },
  { id: "master", kind: "duel", name: "Круг мастеров", place: "Закрытый фехтовальный зал", description: "Сильные дуэлянты с редкой экипировкой и полным набором классовых навыков.", minLevel: 12, requiredDuelWins: 24, requiredArena: 3, enemyLevelOffset: [1, 4], rewardGold: 360, rewardExperience: 260, accent: "#756b9a" },
  { id: "black-seal", kind: "duel", name: "Чёрная печать", place: "Зал без зрителей", description: "Предельные постоянные дуэли против бойцов королевского уровня.", minLevel: 20, requiredDuelWins: 55, requiredArena: 4, enemyLevelOffset: [3, 7], rewardGold: 820, rewardExperience: 480, accent: "#9c5044" },
];
...
export const ENDGAME_ACTIVITIES: EndgameActivityDefinition[] = [
  {
    ...
    rewardGold: 8200, rewardExperience: 2400, accent: "#8c6d2f",
  },
  {
    ...
    rewardGold: 14000, rewardExperience: 3500, accent: "#713f4a",
  },
];
...
const additionalSetSpecs: Array<{
  ...
  {
    id: "salt-road", name: "Соляной тракт", description: "Выцветшее дорожное снаряжение караванщиков, пересекающих белые равнины.",
    purpose: "Универсальная мобильная защита: скорость помогает держать темп, а здоровье и броня страхуют в длинных походах.", classes: "all", stats: ["speed", "health", "defense"],
    pieceNames: { weapon: "Оружие соляного каравана", offhand: "Карта белых дорог", head: "Капюшон соляного ветра", chest: "Пальто белого тракта", hands: "Перчатки канатного узла", feet: "Сапоги сухого брода" },
    bonuses: [
      { pieces: 2, description: "Попутный ветер: +4 к скорости", stats: { speed: 4 } },
      { pieces: 4, description: "Запас воды: +26 к здоровью", stats: { health: 26 } },
      { pieces: 6, description: "Соляная кожа: +7 к защите", stats: { defense: 7 } },
    ],
  },
  {
    id: "scarlet-archive", name: "Багряный архив", description: "Церемониальная бригантина хранителей запретных военных летописей.",
    purpose: "Универсальный точный комплект: критический шанс и защита поддерживают сдержанную прибавку к атаке.", classes: "all", stats: ["crit", "defense", "attack"],
    pieceNames: { weapon: "Реликвия красной строки", offhand: "Печать архивариуса", head: "Личина закрытого фонда", chest: "Бригантина алого архива", hands: "Перчатки переплётчика", feet: "Сапоги хранителя печатей" },
    bonuses: [
      { pieces: 2, description: "Точная помета: +6 п.п. к критическому шансу", stats: { crit: 6 } },
      { pieces: 4, description: "Закрытый переплёт: +6 к защите", stats: { defense: 6 } },
      { pieces: 6, description: "Последняя редакция: +6 к атаке", stats: { attack: 6 } },
    ],
  },
  {
    id: "blue-caravan", name: "Лазурный караван", description: "Короткий набор состоятельной караванной стражи с синей тканью и медной отделкой.",
    purpose: "Универсальная наступательная сборка для тех, кому важны сила и темп без полного отказа от запаса здоровья.", classes: "all", stats: ["attack", "speed", "health"],
    pieceNames: { weapon: "Оружие лазурного каравана", offhand: "Счётная дощечка проводника", head: "Шляпа синего пути", chest: "Камзол караванной стражи", hands: "Перчатки медного счёта", feet: "Сапоги дальнего перехода" },
    bonuses: [
      { pieces: 2, description: "Охрана груза: +5 к атаке", stats: { attack: 5 } },
      { pieces: 4, description: "Смена проводника: +5 к скорости", stats: { speed: 5 } },
      { pieces: 6, description: "Походный запас: +24 к здоровью", stats: { health: 24 } },
    ],
  },
  {
    id: "ashen-court", name: "Пепельный двор", description: "Строгое бронепальто рыцарей и дуэлянтов при дворе угасшей династии.",
    purpose: "Для рыцаря и мечника: равно поддерживает стойкость, силу клинка и запас здоровья в турнирных сериях.", classes: ["Knight", "Swordsman"], stats: ["defense", "attack", "health"],
    pieceNames: { weapon: "Оружие пепельного двора", offhand: "Второй знак присяги", head: "Шлем серого церемониймейстера", chest: "Бронепальто пепельного двора", hands: "Рукавицы угасшей печати", feet: "Сапоги придворного караула" },
    bonuses: [
      { pieces: 2, description: "Серая присяга: +7 к защите", stats: { defense: 7 } },
      { pieces: 4, description: "Право клинка: +7 к атаке", stats: { attack: 7 } },
      { pieces: 6, description: "Дворцовый резерв: +30 к здоровью", stats: { health: 30 } },
    ],
  },
  {
    id: "mist-watch", name: "Туманный дозор", description: "Лёгкое снаряжение стрелков серого берега с разнесённой защитой плеч.",
    purpose: "Для лучника и оружейника: ускоряет дальнюю атаку, повышает точность и оставляет защиту для ответного удара.", classes: ["Archer", "Gunsmith"], stats: ["speed", "defense", "crit"],
    pieceNames: { weapon: "Оружие серого берега", offhand: "Комплект дальнего дозора", head: "Очки линейного тумана", chest: "Куртка туманного дозора", hands: "Наручи росной стали", feet: "Сапоги низкой облачности" },
    bonuses: [
      { pieces: 2, description: "Шаг в молоке: +6 к скорости", stats: { speed: 6 } },
      { pieces: 4, description: "Росная сталь: +6 к защите", stats: { defense: 6 } },
      { pieces: 6, description: "Дальний силуэт: +8 п.п. к критическому шансу", stats: { crit: 8 } },
    ],
  },
  {
    id: "moon-cloister", name: "Лунный скит", description: "Многослойное облачение затворников, обучавших и магов, и мастеров рукопашного боя.",
    purpose: "Для мага и монаха: большой запас здоровья дополняется защитой и скоростью для размеренного боя навыками.", classes: ["Wizard", "Monk"], stats: ["health", "defense", "speed"],
    pieceNames: { weapon: "Реликвия лунного скита", offhand: "Чаша неподвижной воды", head: "Капюшон младшего затвора", chest: "Одеяние лунного скита", hands: "Перчатки ночной службы", feet: "Башмаки беззвучной галереи" },
    bonuses: [
      { pieces: 2, description: "Долгое бдение: +32 к здоровью", stats: { health: 32 } },
      { pieces: 4, description: "Каменный порог: +5 к защите", stats: { defense: 5 } },
      { pieces: 6, description: "Ночная служба: +7 к скорости", stats: { speed: 7 } },
    ],
  },
  {
