...
const itemPalettes = [
  ...
  { primary: "#6f675b", secondary: "#a79b82", dark: "#292724", accent: "#b66f4c" },
  { primary: "#315a72", secondary: "#8a9b94", dark: "#182d38", accent: "#d49a54" },
  { primary: "#704a52", secondary: "#b6aa91", dark: "#2d2227", accent: "#d2b56c" },
...
const profiles: Record<string, VisualProfile> = {
  ...
  "free-company": {
    palette: 31, chest: "coat", head: "hood", shoulders: "soft", motif: "road", variant: 41,
    outerwear: "longcoat", collar: "classic",
  },
  "storm-courier": {
    palette: 32, chest: "tunic", head: "hood", shoulders: "asymmetric", motif: "wing", variant: 42,
    outerwear: "cape",
  },
  "duelist-oath": {
    palette: 33, chest: "brigandine", head: "mask", shoulders: "layered", motif: "cross", variant: 43,
    collar: "ceremonial",
  },
  "quiet-scholar": {
    palette: 34, chest: "robe", head: "hood", shoulders: "soft", motif: "knot", variant: 44,
    collar: "high",
  },
  "border-watch": {
    palette: 35, chest: "brigandine", head: "helmet", shoulders: "guard", motif: "road", variant: 45,
    collar: "classic",
  },
  "ashen-circuit": {
