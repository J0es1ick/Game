...
import { ARENAS, CLASS_DEFINITIONS } from "../../../catalogs/WorldCatalog";
import { FACTIONS } from "../../../catalogs/WorldExpansionCatalog";
import type { LeaderboardEntry } from "../../../gameplay/WorldTypes";
import {
  eraVeteranBadgeCopy,
  loadRankingSnapshot,
  saveRankingSnapshot,
...
import { PageHeading, StatRow, css } from "../components/common";
              ...
              ? previousRank === undefined
                ...
                : delta > 0
                  ...
                  : delta < 0
                    ...
                    : ""
              : "";
            const veteran = eraVeteranBadgeCopy(entry.carriedFromCycle),
