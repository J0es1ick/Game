  ...
  return (
    <>
      <section className="living-world-section world-relics paper-panel">
        ...
        <h2 data-term="worldRelic" tabIndex={0}>
          Мировые реликвии · {relics.length}
        </h2>
        <PagedList
      ...
      <section className="living-world-section world-veterans paper-panel">
        ...
        <h2 data-term="veteran" tabIndex={0}>
          Ветераны · {veterans.length}
        </h2>
        <p className="world-section-intro">
          Многие бойцы продолжают карьеру после смены эпохи и сохраняют свою
          историю, связи и соперников. Свободные места занимают новые участники,
          поэтому состав мира постепенно меняется.
        </p>
        <PagedList
          ...
          render={(fighter) => (
            ...
            >
              <div>
                ...
                <small>
                  Из эпохи {fighter.carriedFromCycle} · эпох в строю:{" "}
                  {game.save.legacy.cycle - fighter.carriedFromCycle! + 1} ·{" "}
