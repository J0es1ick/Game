...
import { Modal, css } from "../components/common";
import { classIcons } from "../components/gameLabels";
import { useGame } from "../state/GameContext";
import { EquipmentArt } from "../equipment/Artwork";
import { itemName, pageSlice, rarityColors } from "../equipment/model";
import { Pagination } from "../equipment/shared";
  ...
  const begin = () => {
    ...
    try {
      ...
      notify({
        ...
        description: `${next.save.hero.name} принимает мир с новыми законами и памятью прежнего героя.`,
        symbol: "Ⅱ",
        tone: "legendary",
        sound: "reputation",
        duration: 3600,
                ...
                <div className="new-chronicle-summary">
                  ...
                  <article>
                    ...
                    <ul>
                      ...
                      <li>Население мира, элита и соперничества</li>
                    </ul>
                    <p>
