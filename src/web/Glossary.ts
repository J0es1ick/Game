...
const glossary: Record<string, GlossaryEntry> = {
  ...
  speed: { title: "Скорость · SPD", description: "Повышает частоту действий. Каждая следующая прибавка даёт меньше темпа: быстрый боец ходит чаще, но не лишает медленного ответных ходов." },
  crit: { title: "Критический шанс · CRIT", description: "Вероятность усиленного удара, максимум 60%. Избыток сверх предела не усиливает крит: вместо него полезнее подобрать другую характеристику." },
  ...
  enemyMemory: { title: "Память соперника", description: "Соперник изучает класс, тактический профиль и часто используемые навыки героя. Чем привычнее ему ваш стиль, тем точнее работают подготовленные контрмеры." },
  styleFamiliarity: { title: "Изученность стиля", description: "Показывает, насколько текущая манера боя похожа на ту, к которой соперник успел подготовиться. Смена навыков, тактики или класса снижает её, но не стирает историю встреч." },
  countermeasure: { title: "Контрмера", description: "Условный ответ на конкретную привычку героя. Он усиливается при повторении знакомого стиля и ослабевает, если герой меняет построение боя." },
  surprise: { title: "Эффект неожиданности", description: "Временное преимущество от заметной смены стиля. Старые знания соперника сохраняются, но часть его контрмер не успевает сработать в текущем бою." },
